...
export class MACDTooltip extends React.Component<MACDTooltipProps> {
  ...
  private readonly renderSVG = (moreProps: any) => {
    ...
    const macd =
      (macdValue?.macd && displayFormat(macdValue.macd)) || displayInit;
    const signal =
      (macdValue?.signal && displayFormat(macdValue.signal)) || displayInit;
    const divergence =
      (macdValue?.divergence && displayFormat(macdValue.divergence)) ||
      displayInit;
